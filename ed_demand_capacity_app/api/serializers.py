...
class AdditionalFactorCapacitySerializer(serializers.ModelSerializer):
    class Meta:
        model = AdditionalFactorCapacity
        fields = '__all__'

class AdditionalFactorDemandSerializer(serializers.ModelSerializer):
    class Meta:
        model = AdditionalFactorDemand
        fields = '__all__'